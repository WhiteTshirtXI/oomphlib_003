...
\mainpage Introduction: The Finite Element Method
...
<TD>
<CENTER>
<CENTER><B> Problem P2<SUB>weak</SUB> </B></CENTER>
...
The weak form of the general problem P can then be written as  \n \n
  ...
  <TD>
  <CENTER>
  <CENTER><B> Problem P<SUB>weak</SUB> </B></CENTER>
...
<TD>
<CENTER>
<CENTER><B> Problem P1<SUB>weak</SUB> </B></CENTER>
...
<TR>
<TD>
<CENTER><B> An aside:  Integration by parts revisited </B></CENTER>
...
\image latex fe_adaptive_interpolant.eps "Adaptive 1D finite element mesh: Non-uniform spacing of nodes to achieve a high resolution only where it is required. " width=0.75\textwidth
 ...
 <TR>
 <TD>
 <CENTER><B> An aside: adaptive mesh refinement </B></CENTER>
