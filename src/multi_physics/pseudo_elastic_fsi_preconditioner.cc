...
namespace oomph {
 ...
 void PseudoElasticFSIPreconditioner::setup()
 {
  ...
  if (Use_navier_stokes_schur_complement_preconditioner)
   {
    ...
    Navier_stokes_schur_complement_preconditioner_pt->Preconditioner::setup(problem_pt(),
                                                            matrix_pt());
   }
  else
   {
  ...
  Pseudo_elastic_preconditioner_pt->Preconditioner::setup(problem_pt(),matrix_pt());
