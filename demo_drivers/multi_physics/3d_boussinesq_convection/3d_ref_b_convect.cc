...
//============================================================================ 
/// \short Boussinesq preconditioner. This extracts upper/lower triangular
...
public :
 ...
 /// retained fluid on temperature terms.
...
// MatrixVectorProduct* Mat_vec_operator_1_0_pt;
 ...
 /// \short Boolean flag used to indicate that the temperature onto fluid
 /// interaction terms are to be retained
 bool Retain_temperature_onto_fluid_terms;

 /// \short Boolean flag used to indicate that the fluid onto temperature
 /// interaction terms are to be retained
...
void BoussinesqPreconditioner::setup()
 {
  ...
  Temperature_preconditioner_pt->setup(problem_pt(),block_matrix_1_1_pt);
...
public:
 ...
 /// \short Actions after adaptation (empty)
...
{ 
 ...
 BoussinesqPreconditioner* prec_pt = new BoussinesqPreconditioner;
